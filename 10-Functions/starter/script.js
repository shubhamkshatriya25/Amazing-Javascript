...
const pole = {
  ...
  displayResults(type = 'array') {
    ...
    else if (type === 'string') console.log(this.answers.join(', '));
  },
};

document
  .querySelector('.poll')
  .addEventListener('click', pole.registerNewAnswer.bind(pole));

const data1 = [5, 2, 3];
const data2 = [1, 5, 3, 9, 6, 1];
pole.displayResults.call({ answers: data1 });
pole.displayResults.call({ answers: data2 }, 'string');
